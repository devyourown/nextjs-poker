...
const SECRET_SUCCESS = "Secret Code sended.";
const SECRET_FAILURE = "Code is not sended. Please re-try";
...
export default function SignupForm() {
    ...
    const sendMail = useCallback(async () => {
        ...
        if (result.status === 201) {
            setEmailSend(SECRET_SUCCESS);
        } else {
            setEmailSend(SECRET_FAILURE);
        }
    }, []);
            ...
            <div className="flex-1 rounded-lg bg-gray-50 px-6 pb-4 pt-8">
                ...
                <div className="w-full">
                    ...
                    <div>
                        ...
                        <button onClick={sendMail}>Send Secret Code</button>
                        {emailSend && (
                            <div
                                style={{
                                    color:
                                        emailSend === SECRET_SUCCESS
                                            ? "green"
                                            : "red",
                                }}
                            >
                    ...
                    <div className="mt-4">
                        ...
                        <div className="relative">
                            <input
                                ...
                                type="text"
                                name="secret"
                                placeholder="Enter Email Secret Key"
                                required
                            />
